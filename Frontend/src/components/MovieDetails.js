...
const MovieDetails = ({ movie, onClose }) => {
  ...
  // Auto-close modal if clicking outside
  useEffect(() => {
  ...
  // Render unique watch providers for the first region
  const renderProviders = useMemo(() => {
    ...
    const uniqueProviders = [
      ...
      .slice(0, 4); // Limit to 4 to avoid overflow
      ...
      >
        ...
        <div className="flex flex-col gap-4">
          ...
          <div>
            ...
            <button
              className={`w-full py-2 px-4 rounded-lg font-semibold text-white transition-transform transform ${
                isMovieInList()
